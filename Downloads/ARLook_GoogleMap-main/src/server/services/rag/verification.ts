/**
 * ============================================================================
 * RAG 系统 - 验证系统 (Verification System)
 * ============================================================================
 * 
 * 位置: src/server/services/rag/verification.ts
 * 
 * 职责:
 * - 验证 AI 回复中只提及检索到的真实房源
 * - 检查数据一致性（价格、距离等准确性）
 * - 检测和防止 AI 幻觉（hallucination）
 * - 计算 RAG 系统性能指标
 * - 清理和修复 AI 回复中的错误信息
 * 
 * 核心功能:
 ...
 * - verifyAndFilterProperties(): 综合验证和过滤
 * 
 * 使用场景:
 * - AI 生成回复后，验证其准确性
 * - 计算 RAG 系统性能指标
 ...
 * 
 * 相关文件:
 * - retrieval.ts: 检索器（提供检索结果用于验证）
 * - /api/chat/route.ts: 主 API（使用此验证系统）
 * 
 * ============================================================================
 */
