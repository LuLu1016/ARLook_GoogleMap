/**
 * ============================================================================
 * RAG 系统 - 推理引擎 (Reasoning Engine)
 * ============================================================================
 * 
 * 位置: src/server/services/rag/reasoning.ts
 * 
 * 职责:
 * - 多阶段智能推理管道，处理用户租房查询
 * - Stage 1: 需求澄清 - 判断是否需要更多信息
 * - Stage 2: 策略选择 - 选择最佳搜索策略
 * - Stage 3: 结果排序 - 根据用户偏好个性化排序
 * - Stage 4: 建议生成 - 生成个性化建议
 * 
 * 核心类:
 * - RentalReasoningEngine: 推理引擎主类
 * 
 * 关键方法:
 * - clarifyNeeds(): 澄清用户需求
 * - selectSearchStrategy(): 选择搜索策略
 * - rankAndExplain(): 排序和解释结果
 ...
 * 
 * 相关文件:
 * - retrieval.ts: 检索器（使用此引擎的策略选择）
 * - /api/chat/route.ts: 主 API（使用此引擎进行推理）
 * 
 * ============================================================================
 */
